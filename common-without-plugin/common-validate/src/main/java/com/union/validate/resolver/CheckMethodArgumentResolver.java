package com.union.validate.resolver;

import com.union.validate.BaseValidator;
import com.union.validate.BindResult;
import com.union.validate.ValidatorCache;
...
public class CheckMethodArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    private final Map<MethodParameter, CheckNamedValueInfo> namedValueInfoCache = new ConcurrentHashMap(256);
